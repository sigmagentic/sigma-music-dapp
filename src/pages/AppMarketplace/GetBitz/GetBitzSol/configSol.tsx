...
export const faqs = [
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          You need to HODL a {`BiTz`} compatible Data NFT in your wallet to play the Get {`BiTz`} game (you are on this page now). This Data NFT was airdropped
          in waves to OGs of the Itheum Protocol, but fear not, you can also get it through{" "}
          <a className="!text-[#7a98df] hover:underline" href="https://drip.haus/itheum" target="blank">
            Itheum&apos;s DRiP Haus channel{" "}
          </a>
          or any NFT Marketplace (if the OGs broke our hearts and parted ways with their Data NFTs). If you missed the previous {`BiTz`} Data NFT drops, you can
          subscribe to{" "}
          <a className="!text-[#7a98df] hover:underline" href="https://drip.haus/itheum" target="blank">
  ...
  },
  {
    ...
    content: (
      <>
        <p>
          Itheum {`BiTz`} is like an XP system and you collect {`BiTz`} each time you interact with certain features of Itheum Protocol. Like all XP Systems,
          there is a LEADERBOARD-based rewards system that is tied to use cases within the Itheum protocol. At launch, the following utility will be available:
        </p>
    ...
    content: (
      <>
        ...
        <p>
          ...
          where you can &quot;gift&quot; them to Data Creators who mint Data NFT Collections. &quot;Gifting&quot; Itheum {`BiTz`} will have its own LEADERBOARD
          and perks ;)
        </p>
      </>
    ),
    ...
    content: (
      <>
        <p>
          ...
          {`BiTz`} XP. We will also be rolling out soon some new blockchain powered &quot;liveliness & reputation signalling&quot; features that should prevent
          or drastically reduce possible XP sybil attacks.
        </p>
      </>
    ),
  },
    ...
    content: (
      <>
        ...
        <p>
          ...
          Itheum {`BiTz`} XP system? Reach out and you could get a grant via the{" "}
          <a
