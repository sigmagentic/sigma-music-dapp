...
export const rewardPools: RewardPool[] = [
  {
    id: "rp1",
    name: "Music fans win a share of 10% of total sales of the platform",
    description:
      "Holding a collectible is your raffle ticket to win a share of 10% of total sales of the collectibles. Owning more than one collectible will increase your chances of winning.",
    ...
    eligibility: [
      "You must buy and own a fan (music or fan membership) collectible. If someone else sent it to your wallet, you will not be eligible. You MUST have purchased it yourself.",
    ],
    // cta: {
  ...
  {
    id: "rp3",
    name: "USDC rewards for most engaged artists",
    description:
      "Artists who are most engaged with the Sigma Music platform and have the most fan engagement (e.g. most streams, most power-ups, most boosts, most social engagement, most albums launched on Sigma Music, etc.) will win a share of the pool.",
    startDate: "2025-07-01",
    endDate: "2025-07-31",
    featured: true,
    totalWinners: 10,
    ...
    terms: [
      "We analyse the engagement of artists on the Sigma Music platform and select the top artists with the most engagement",
      "We can only distribute rewards as USDC to Solana wallets",
      "All winners are final and no appeals will be entertained",
      "Winners are responsible for reaching out to us to claim their rewards",
      "We reserve the right to not distribute rewards if the winner does not reach out to us within 10 days of the end date",
