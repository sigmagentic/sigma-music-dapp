...
export const LOG_STREAM_EVENT_METRIC_EVERY_SECONDS = 15;
...
export const ALL_MUSIC_GENRES = [
  ...
  { code: "trap", label: "Trap", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=trap" },
  ...
  { code: "alternative", label: "Alternative", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=alternative" },

  { code: "country", label: "Country", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=country" },
  { code: "classical", label: "Classical", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=classical" },
  ...
  { code: "garage track", label: "Garage Track", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=garage+track" },
  { code: "afropop", label: "Afropop", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=afropop" },

  { code: "trance", label: "Trance", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=trance" },
  { code: "breakbeat", label: "Breakbeat", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=breakbeat" },
  { code: "deep house", label: "Deep House", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=deep+house" },
  { code: "boombap", label: "Boombap", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=boombap" },
  {
    code: "dark hip hop",
    label: "Dark Hip Hop",
    tier: GenreTier.TIER2,
  ...
  { code: "lofi", label: "Lo-Fi", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=lofi" },
  { code: "instrumental", label: "Instrumental", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=instrumental" },
  { code: "world beat", label: "World Beat", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=world+beat" },
  { code: "drill", label: "Drill", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=drill" },
  { code: "dark trap", label: "Dark Trap", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=dark+trap" },

  { code: "rock ballad", label: "Rock Ballad", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=rock+ballad" },
  { code: "alternative rock", label: "Alternative Rock", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=alternative+rock" },
  {
    code: "pop rock",
    label: "Pop Rock",
    tier: GenreTier.TIER2,
  ...
  { code: "metal", label: "Metal", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=metal" },
  { code: "electro", label: "Electro", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=electro" },

  { code: "ambient", label: "Ambient", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=ambient" },
  { code: "dream pop", label: "Dream Pop", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=dream+pop" },
  { code: "electronica", label: "Electronica", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=electronica" },
  { code: "soundtrack", label: "Soundtrack", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=soundtrack" },
  { code: "dubstep", label: "Dubstep", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=dubstep" },
  { code: "jungle", label: "Jungle", tier: GenreTier.TIER2, tileImgBg: "https://placehold.co/200x200/facc14/000?text=jungle" },
  {
    code: "vibrant electronic",
    label: "Vibrant Electronic",
    tier: GenreTier.TIER2,
    tileImgBg: "https://placehold.co/200x200/facc14/000?text=vibrant+electronic",
  },

  { code: "breakcore", label: "Breakcore", tier: GenreTier.FRINGE, tileImgBg: "https://placehold.co/200x200/facc14/000?text=breakcore" },
  { code: "cyberpunk", label: "Cyberpunk", tier: GenreTier.FRINGE, tileImgBg: "https://placehold.co/200x200/facc14/000?text=cyberpunk" },
  { code: "gypsy", label: "Gypsy", tier: GenreTier.FRINGE, tileImgBg: "https://placehold.co/200x200/facc14/000?text=gypsy" },
  { code: "spoken word", label: "Spoken Word", tier: GenreTier.FRINGE, tileImgBg: "https://placehold.co/200x200/facc14/000?text=spoken+word" },
];
