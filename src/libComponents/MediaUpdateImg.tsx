...
export const MediaUpdateImg: React.FC<MediaUpdateImgProps> = ({ imageUrl, size = "md", onFileSelect, onFileRevert, alt = "Media", className = "" }) => {
  ...
  const handleFileChange = (event: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      if (validTypes.includes(file.type)) {
        ...
        alert("Please select a valid image file (GIF, JPG, or PNG)");
      }
    }
