...
type State = {
  ...
  artistIdBeingPlayedInPlaylist: string | undefined;
...
type Action = {
  ...
  updateArtistIdBeingPlayedInPlaylist: (artistIdBeingPlayedInPlaylist: State["artistIdBeingPlayedInPlaylist"]) => void;
...
export const useAudioPlayerStore = create<State & Action>((set) => ({
  ...
  artistIdBeingPlayedInPlaylist: undefined,
  ...
  updateArtistIdBeingPlayedInPlaylist: (artistIdBeingPlayedInPlaylist: State["artistIdBeingPlayedInPlaylist"]) =>
    set(() => ({ artistIdBeingPlayedInPlaylist: artistIdBeingPlayedInPlaylist })),
